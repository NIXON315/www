...
require_once 'includes/modals/ModalsEditConfigRoles.php';
?>
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-users"></i> Roles</h1>
          <p>Configuración Tipo de Roles.</p>
          <button type="button" class="btn btn-success" type="button" onclick="openModalRoles()">Nuevo Rol</button>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Config. Roles</a></li>
        </ul>
      </div>
