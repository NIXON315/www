...
require_once 'includes/modals/ModalsBankQuestion.php';
?>
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <div>
          <h1><i class="fa fa-users"></i> Banco de Preguntas</h1>
          <p>Banco de Preguntas.</p>
          <button type="button" class="btn btn-success" type="button" onclick="openModalBankQuestion()">Nueva Configuración</button>

        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Banco de Preguntas</a></li>
        </ul>
        ...
        <div class="col-md-12">
          ...
          <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="tableBankQuest">
                  <thead>
                    <tr>
